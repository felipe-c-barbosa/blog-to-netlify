---
layout: page
title: "Análise Crítica e Curadoria do Cânone de Gestão de Produtos: Um Relatório Profundo sobre a Bibliografia"
permalink: /livros-para-profissionais/livros-produto
...
1.  **Risco de Valor:** O cliente vai comprar/usar?
2.  **Risco de Usabilidade:** O cliente consegue usar?
3.  **Risco de Viabilidade Técnica:** A engenharia consegue construir?
4.  **Risco de Viabilidade de Negócio:** O produto sustenta o modelo de negócios?
...
| :--- | :--- | :--- | :--- |
| **Sprint** | Jake Knapp, John Zeratsky, Braden Kowitz | Metodologia do Google Ventures para prototipar e validar soluções em 5 dias. Essencial para discovery rápido. | [Amazon](https://amzn.to/2rv7z9h) |
| **Don’t Make Me Think** | Steve Krug | Clássico de usabilidade. Ensina que a navegação deve ser autoevidente para reduzir a carga cognitiva do usuário. | [Amazon](https://amzn.to/36TWJdb) |
| **Design Para Quem Não É Designer** | Robin Williams | Princípios visuais fundamentais (alinhamento, contraste) para não-especialistas avaliarem interfaces. | [Amazon](https://amzn.to/32C7nC1) |
| **Gestão e Desenvolvimento de Produtos e Marcas** | Hélio Arthur Reis Irigaray et al. | Abordagem acadêmica da FGV sobre o ciclo de vida do produto e gestão de marcas no contexto brasileiro. | [Amazon](https://amzn.to/36X4K18) |
| **Neuro Web Design** | Susan Weinschenk | Explora os gatilhos mentais e a neurociência por trás da tomada de decisão e cliques em interfaces digitais. | [Amazon](https://amzn.to/2qGFjQJ) |
| **Scrum: A Arte de Fazer o Dobro...** | Jeff Sutherland | O livro fundamental do co-criador do Scrum. Foca na filosofia de inspeção e adaptação para gerir complexidade. | [Amazon](https://amzn.to/33HoF27) |
| **The Lean Product Playbook** | Dan Olsen | Guia tático para alcançar o Product-Market Fit, com frameworks para definir cliente-alvo e proposta de valor. | [Amazon](https://amzn.to/372RCrt) |
| **Scrum e Métodos Ágeis: Um Guia Prático** | Rafael Sabbagh | Referência brasileira. Traduz a teoria do Scrum para a prática das empresas nacionais, focando em papéis e rituais. | [Amazon](https://amzn.to/36Yi4SV) |
| **The Product Book** | Product School | Manual abrangente cobrindo os fundamentos da carreira de PM, ideal para iniciantes e transição de carreira. | [Amazon](https://amzn.to/2KcSHCU) |
| **Inspired** | Marty Cagan | A leitura obrigatória da área. Define a diferença cultural e processual entre times de funcionalidade e times de produto. | [Amazon](https://amzn.to/2pWeFDC) |
| **Hooked** | Nir Eyal | Psicologia do engajamento. Apresenta o modelo de "Gatilho-Ação-Recompensa" para criar produtos viciantes. | [Amazon](https://amzn.to/2QdkO8W) |
| **Direto Ao Ponto** | Paulo Caroli | Foca na criação de produtos enxutos (Lean), introduzindo conceitos chave para a definição eficiente de MVPs. | [Amazon](https://amzn.to/2O7aX1M) |
| **Talking to Humans** | Giff Constable | Guia prático para Customer Development. Ensina como entrevistar usuários sem enviesar as respostas. | [Amazon](https://amzn.to/2O2UYlv) |
| **Product Management in Practice** | Matt LeMay | Aborda o dia a dia caótico do PM, focando em comunicação, empatia e habilidades de conexão ("glue"). | [Amazon](https://amzn.to/2QbDCWg) |
| **Lean Inception** | Paulo Caroli | Método de workshop colaborativo (5 dias) para alinhar times técnicos e de negócio na definição do MVP. | [Amazon](https://amzn.to/2NEcuxs) |
| **User Story Mapping** | Jeff Patton | Técnica visual para organizar backlogs focando na jornada do usuário, evitando a perda da visão holística do produto. | [Amazon](https://amzn.to/2qKO2l3) |
| **Microcopy** | Kinneret Yifrah | O guia definitivo de UX Writing. Mostra como pequenas palavras impactam a experiência e a conversão. | [Amazon](https://amzn.to/33QuJpb) |
| **Gestão de Produtos** | Joaquim Torres (Joca) | A "enciclopédia" brasileira de PM (473 págs). Cobre estratégia, roadmap, métricas e liderança de times. | [Amazon](https://amzn.to/2Kgn23w) |
| **Intercom on Product Management** | Intercom | Coletânea de ensaios práticos da empresa Intercom sobre construção, lançamento e evolução de produtos SaaS. | [Intercom](https://www.intercom.com/pt-BR/books/product-management) |
| **The Handy Guide for Product People** | ProdPad | Guia de bolso com dicas rápidas e frameworks para consulta imediata no cotidiano da gestão de produtos. | [ProdPad](https://www.prodpad.com/resources/handy-guide/) |
| **The Customer Interview Toolbox** | ProductPlan | Ferramentas específicas e roteiros para planejar e executar pesquisas qualitativas com clientes. | [ProductPlan](https://www.productplan.com/lp/customer-interview-tool-box/) |
| **Value Proposition Design** | Alexander Osterwalder et al. | Dos criadores do Business Model Canvas. Ferramenta visual para alinhar as "dores" do cliente com os "remédios" do produto. | [Amazon](https://amzn.to/2sNKnEn) |
| **Essential Kanban Condensed** | David J. Anderson, Andy Carmichael | Introdução densa (100+ págs) ao método Kanban, focada em fluxo, limitação de WIP e sistemas puxados. | [Amazon](https://amzn.to/2RVqlQI) |
| **Product Management** | Donald R. Lehmann, Russell S. Winer | Texto acadêmico robusto (460+ págs) focado na gestão de marketing, ciclo de vida e brand equity do produto. | [Amazon](https://amzn.to/37yv0ic) |
| **Em Busca de Boas Práticas em UX Writing** | Bruno Rodrigues | O primeiro livro brasileiro dedicado ao tema. Foca na clareza e acessibilidade textual em interfaces em português. | [Amazon](https://amzn.to/2Vbl0bk) |
| **Shape Up** | Ryan Singer (Basecamp) | Alternativa ao Scrum. Propõe ciclos de 6 semanas e o conceito de "apetite" (tempo fixo) em vez de estimativas de escopo. |([https://basecamp.com/shapeup](https://basecamp.com/shapeup)) |
| **Gestão Moderna de Produtos Digitais** | Diego Eis | Visão contemporânea de um líder brasileiro sobre a cultura de produto e a gestão de produtos digitais no país. | [Amazon](https://amzn.to/2TqfT5c) |
| **Métricas Ágeis** | Raphael Donaire Albino | Guia técnico para uso de dados (CFD, Lead Time) visando previsibilidade e melhoria de processos em times ágeis. | [Amazon](https://amzn.to/2XqWW3R) |
| **Sprint a Sprint** | Mary Provinciatto, Paulo Caroli | Foca na transformação cultural, uso de retrospectivas e aprendizados reais na implementação de métodos ágeis. | [Amazon](https://amzn.to/38aUmUk) |
| **Escaping the Build Trap** | Melissa Perri | Ensina a transição de uma cultura de entregas (output) para uma cultura de valor e resultados (outcomes). | [Amazon](https://www.felipebarbosa.me/livros-para-profissionais/) |
